...
│  └── Exécution audit + rapport (Personne D)
│
...
| 7-11 min | **Démo live** Module 1 (diagnostic DC01 + WMS-DB) puis Module 2 (backup) | Personne B + C |
| 11-15 min | **Démo live** Module 3 (scan + rapport EOL) | Personne D |
